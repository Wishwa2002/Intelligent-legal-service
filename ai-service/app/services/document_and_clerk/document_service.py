"""
app/services/document_and_clerk/document_service.py
...
SAMPLE_DOCS_DIR = Path(__file__).parent.parent.parent.parent / "sample_documents"
...
async def analyze_document_bytes(
    ...
    """Direct extraction and Gemini analysis from in-memory bytes."""
    settings = get_settings()
    gemini = get_gemini_service()
