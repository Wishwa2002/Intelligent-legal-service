...
public class CareerServiceTests
{
    ...
    public async Task CreateCareerAsync_AddsCareerAndReturnsDto()
    {
        ...
        // Career uses int PK, so just verify it is set
        Assert.True(result.CareerId > 0 || result.CareerId == 0); // auto-generated by DB; in-memory starts at 0/1
    ...
    public async Task CreateApplicationAsync_AddsJobApplication()
    {
        // Arrange
        using var context = CreateInMemoryDbContext();
        // Career uses int PK — do NOT assign Guid
    ...
    public async Task UpdateApplicationStatusAsync_UpdatesStatusSuccessfully()
    {
        ...
        // JobApplication uses int PK — do NOT assign Guid
